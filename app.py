...
APP_VERSION = "2.1.1"  # Major.Minor.Patch - Pipeline test
...
def get_mood_display_info(mood_key):
    ...
    mood_names = {
        ...
        "chill": "Chill", "romantic": "Romantic", "motivated": "Motivated", 
        "sleepy": "Sleepy", "focused": "Focused", "party": "Party", 
        "nostalgic": "Nostalgic", "angry": "Angry", "melancholy": "Melancholy", 
        "uplifting": "Uplifting", "meditative": "Meditative", "running": "Running"
    }
...
def search_playlists():
    ...
    try:
        ...
        for mood_key, playlist_id in mood_playlists.items():
            ...
            matches = (
                query in mood_key.lower() or                                    # Direct mood key match
                query in mood_info.get("name", "").lower() or                   # Display name match
                query in mood_info.get("description", "").lower() or            # Description content match
                any(query in keyword.lower() for keyword in mood_info.get("keywords", []))  # Keyword semantic match
            )
